...
export default function ContactSection() {
  ...
  const inputCls = "w-full bg-cream border border-black/10 hover:border-black/20 focus:border-orange-DEFAULT rounded-xl px-4 py-3 text-sm text-ink placeholder:text-stone outline-none transition-all";

  return (
    <section id="contact" ref={ref} className="relative py-28 bg-cream overflow-hidden">
      {/* Blobs */}
      <div className="absolute top-0 left-0 w-64 h-64 bg-orange-pale blob opacity-60 pointer-events-none -translate-x-1/3 -translate-y-1/3" />
      <div className="absolute bottom-0 right-0 w-52 h-52 bg-orange-pale blob opacity-50 pointer-events-none translate-x-1/4 translate-y-1/4" />
            ...
            <div className="card p-8">
              ...
              <form onSubmit={onSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <textarea name="message" value={form.message} onChange={onChange} required rows={5} placeholder="Tell me about your project or opportunity..." className={`${inputCls} resize-none`} />
                </div>
